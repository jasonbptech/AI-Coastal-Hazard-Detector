...
System Workflow
Pre-warning: Integration of meteorological data to assess hazard probability.

Real-time Detection: Computer vision identifies hazards as they occur.

Post-disaster Tracking: Locks onto victims to streamline rescue operations.
